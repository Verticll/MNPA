...
Devices = [struct('type','R', 'pos', 1, 'neg', 2, 'a', G1,'b',5,'c',7),...
           struct('type','R', 'pos', 2, 'neg', 0, 'a', G2,'b',5,'c',7),...
           struct('type','R2', 'pos', 2, 'neg', 0, 'a', G3,'b',5,'c',7),...
           struct('type','R', 'pos', 3, 'neg', 4, 'a', G4,'b',5,'c',7),...
           struct('type','R', 'pos', 4, 'neg', 0, 'a', Go,'b',5,'c',7),...
           struct('type','V', 'pos', 1, 'neg', 0, 'a', Vin,'b',6,'c',7),...
           struct('type','CV', 'pos', 3, 'neg', 0, 'a', alpha,'b',5,'c',7)
           ];
%Had to change node 3 to 2 in order to accomidate the inductor being...
%shorted in DC
